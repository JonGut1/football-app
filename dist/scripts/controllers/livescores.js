...
angular.module('worldCupScoresApp').controller('LivescoresCtrl', ['matchesStore', '$scope', function (match, $scope) {
  var t = this;
  //console.log($scope);
  ...
  match.promiseCheck.then(function (response) {
    match.getFixtures(response._links).then(function (resp) {
      console.log(resp);
    ...
    match.getTimes(response._links).then(function (resp) {
      console.log(resp);
    });
  });
}]);
}).call(this,require("FT5ORs"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_86bf7d4c.js","/")
},{"FT5ORs":4,"buffer":2}]},{},[5])
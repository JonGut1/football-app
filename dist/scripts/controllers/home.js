...
/**
 * @ngdoc function
 * @name worldCupScoresApp.controller:HomeCtrl
 * @description
 * # HomeCtrl
 * Controller of the worldCupScoresApp
 */

angular.module('worldCupScoresApp').controller('HomeCtrl', function () {
  var thys = this;
  this.name = 'Jonas';
});
}).call(this,require("FT5ORs"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_78419146.js","/")
},{"FT5ORs":4,"buffer":2}]},{},[5])